---
title: "Tutorial de uso de 'PortalHacienda'"
...
Identificamos el 'serie_id' de la series que nos interesa, en este caso "174.1_T_DE_CATES_0_0_32".
...
La función nos indica el modelo que auto-detectó.

```{r forecast}
TCN <- TCN <- Forecast(TCN, N = 12 , confidence = c(80))
```


## 5. Listo!

Ya tenemos la proyección de la serie en 'TCN'
